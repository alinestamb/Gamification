...
<Box>
        ...
        <Grid item xs ={8} bgcolor="#D0C7E5" sx={{border:'10px solid #8E68E6', alignItems:"center"}}>
          <Typography variant="h6" p={2} sx={{fontFamily:"Gamer"}}>Course</Typography>        
            <List>
              <ListItem>
                <Typography sx={{fontSize:"13px"}}>Learn this subject Content</Typography>
              </ListItem>
              <ListItem>
                <img src={Img6} alt="Quiz" style={{ width: '20px', height: '20px' }} />
                <Typography sx={{fontSize:"10px"}}> &nbsp;3 Quizzes</Typography>
              </ListItem>
              <ListItem>
                <img src={Img7} alt="Time" style={{ width: '20px', height: '20px' }} />
                <Typography sx={{fontSize:"10px"}}> &nbsp;70 mins</Typography>
              </ListItem>
            </List>
        </Grid>
        </Grid>
        <br />
        <Grid sx={{border:"2px solid 4f4f4f4"}}>
        <Grid item xs ={8} bgcolor="#e3e9df" sx={{border:'10px solid #c5d1be', alignItems:"center"}}>
          <Typography variant="h6" p={2} sx={{fontFamily:"Gamer"}}>Course</Typography>        
            <List>
              <ListItem>
                <Typography sx={{fontSize:"13px"}}>Learn this subject Content</Typography>
